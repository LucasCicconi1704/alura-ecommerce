    ...
    connectedCallback(){
        ...
        <footer class="footer">
            <div class="footer__container">
                <nav class="footer__nav">
                    <ul class="footer__nav__list">
                        <li class="footer__nav__list-item logo"><a href="index.html"><img src="./assets/img/logo_sample.png" alt=""></a></li>
            ...
            <section class="footer__rodapie">
                <p class="footer__roapie-text">Desarrollado por Lucas Cicconi <br> <span>2022</span></p>
            </section>
